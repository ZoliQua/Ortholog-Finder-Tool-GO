...
// INCLUDING files
	...
	include_once($folderIncl . "inc_variables.php"); // INCL functions
	include_once($folderIncl . "inc_analyzer.php"); // INCL functions
...
<!-- Google Analytics END //-->
	...
	<div id="main-content">
		<h2><a href name='zero'></a>Dumper</h2>

		<div id="center"><?php include_once("includes/page_2_dumper.php"); ?></div>
